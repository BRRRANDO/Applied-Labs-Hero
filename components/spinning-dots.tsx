...
<nav
className="fixed top-0 left-0 right-0 z-[200] font-sans"
style={{ marginTop: "24px", marginLeft: "32px", marginRight: "32px" }}
>
<div className="flex items-center justify-between text-sm">
<div className="font-decimal text-[15px] font-[350] leading-[130%]" style={{ color: textColor, transition: "color 500ms ease-out" }}>
            APPLIED LABS
</div>
<div
...
<span
key={item}
className="font-neue-montreal text-[15px] font-[500] leading-[150%] transition-opacity duration-300"
...
<div
className="font-decimal text-[15px] font-[350] leading-[130%] transition-opacity duration-500 ease-out cursor-pointer"
style={{
...
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center font-sans z-[100] pointer-events-none">
<h1
className="font-decimal text-[22px] font-[350] leading-[130%] tracking-[-0.66px] uppercase transition-colors duration-500 ease-out"
...
<p
className="font-neue-montreal font-[500] text-[15px] leading-[150%] mt-4 leading-relaxed max-w-2xl mx-auto transition-colors duration-500 ease-out"
style={{ color: textColor }}
>
...
<button
className="font-decimal text-[15px] font-[350] leading-[130%] pointer-events-auto mt-6 transition-all duration-500 ease-out cursor-pointer"
style={{
...
>
<p className="font-neue-montreal font-medium text-xs mb-[28px]" style={{ color: "#000000" }}>
...
<div key={setIndex} className="flex items-center shrink-0 font-neue-montreal font-medium" style={{ fontSize: "22px" }}>
...
>
<p className="font-neue-montreal font-medium text-xs mb-[28px] text-right" style={{ color: "#000000" }}>
