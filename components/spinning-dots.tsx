    ...
    >
      ...
      >
        <div className="flex items-center justify-between text-sm">
          <div className="font-semibold" style={{ color: textColor, transition: "color 500ms ease-out" }}>
            APPLIED LABS
          </div>
          <div
          ...
          >
            {["Products", "Industries", "Customers", "Company"].map((item) => (
              <span
                key={item}
          ...
          <div
            className="font-semibold transition-opacity duration-500 ease-out cursor-pointer"
            style={{
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center font-sans z-[100] pointer-events-none">
        ...
        <p
          className="text-sm mt-4 leading-relaxed max-w-2xl mx-auto transition-colors duration-500 ease-out"
          style={{ color: textColor }}
        >
        ...
        <button
          className="text-sm pointer-events-auto mt-6 transition-all duration-500 ease-out cursor-pointer"
          style={{
      ...
      >
        <p className="font-sans text-xs mb-[28px]" style={{ color: "#000000" }}>
          ...
          <div className="relative w-full h-full">
            <div className="absolute inset-0 flex items-center animate-logo-scroll-faster" style={{ opacity: 0.8 }}>
              {[...Array(2)].map((_, setIndex) => (
                <div key={setIndex} className="flex items-center shrink-0 font-sans" style={{ fontSize: "22px" }}>
      ...
      >
        <p className="font-sans text-xs mb-[28px] text-right" style={{ color: "#000000" }}>
